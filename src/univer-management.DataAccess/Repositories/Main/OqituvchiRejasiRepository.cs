...
{
    public class OqituvchiRejasiRepository : GenericRepository<Oqituvchi_Rejasi>, IOqituvchiRejasiRepository
    {
        public OqituvchiRejasiRepository(AppDbContext appDbContext) : base(appDbContext)
        {
        }
    }
}
