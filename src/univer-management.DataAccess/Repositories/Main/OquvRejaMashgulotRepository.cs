...
{
    public class OquvRejaMashgulotRepository : GenericRepository<Oquv_Reja_Mashgulot>, IOquvRejaMashgulotRepository
    {
        public OquvRejaMashgulotRepository(AppDbContext appDbContext) : base(appDbContext)
        {
        }
    }
}
