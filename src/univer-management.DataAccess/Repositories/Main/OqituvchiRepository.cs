...
{
    public class OqituvchiRepository : GenericRepository<Oqituvchi>, IOqituvchiRepository
    {
        public OqituvchiRepository(AppDbContext appDbContext) : base(appDbContext)
        {
        }
    }
}
