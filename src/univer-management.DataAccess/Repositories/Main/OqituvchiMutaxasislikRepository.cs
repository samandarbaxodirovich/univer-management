...
{
    public class OqituvchiMutaxasislikRepository : GenericRepository<Oqituvchi_Mutaxasislik>, IOqituvchiMutaxasislikRepository
    {
        public OqituvchiMutaxasislikRepository(AppDbContext appDbContext) : base(appDbContext)
        {
        }
    }
}
